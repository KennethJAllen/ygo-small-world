...
<img src="https://github.com/KennethJAllen/YGO-small-world/blob/main/example-images/mathmech-graph.png" width="500" />
...
<img src="https://github.com/KennethJAllen/YGO-small-world/blob/main/example-images/mathmech-adjacency-matrix.png" width="500" />
...
<img src="https://github.com/KennethJAllen/YGO-small-world/blob/main/example-images/mathmech-adjacency-matrix-squared.png" width="500" />
...
If there are $n$ possible bridges $b$, then calculating the Small World bridge score for every bridge with this approach only takes $O(nN^2)$ multiplications. This is much better than the naive approach of performing the full matrix multiplication for $M_b^2$ for each bridge $b$, which would take $O(nN^3)$ multiplications.
